...
from writer import MySqlWriter,CsvWriter,TxtWriter,SqliteWriter,JsonWriter,MongoWriter,KafkaWriter
from superparser import AlbumParser, IndexParser, PageParser, PhotoParser
...
def main(_):
    # absl 输入参数
    # print('echo is', FLAGS.config_path)
    # print('user_id_list',FLAGS.user_id_list)
    # print('output_dir',FLAGS.output_dir)
    print(datetime.now()," main func start...")
    #----------------------------------#
    try:
        print("Spider Start...")
        config = _get_config()
